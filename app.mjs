...
for (const [key,id] of [['low','low-example'],['launch','launch-example'],['wording','wording-example'],['cleanOldList','clean-old-list-example'],['newSender','new-sender-example'],['cleanNoUnsubscribe','clean-no-unsubscribe-example'],['cleanAuthHighBounce','clean-auth-high-bounce-example'],['reactivation','reactivation-example'],['high','high-example']]) {
